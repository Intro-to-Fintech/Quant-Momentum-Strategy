...
IEX_CLOUD_API_TOKEN = 'pk_265cf95883aa4fb8989461a752b1edde'
symbol = 'AAPL'
...
for symbol_string in symbol_strings:
    ...
    for symbol in symbol_string.split(','):
        if symbol in data:
            hqm_dataframe = hqm_dataframe._append(pd.Series([symbol, 
                                                   data[symbol]['quote']['latestPrice'],
                                                   'N/A',
                                                   data[symbol]['stats']['year1ChangePercent'],
                                                   'N/A',
...
writer = pd.ExcelWriter('/Users/luke/Downloads/momentum_strategy.xlsx', engine="xlsxwriter")
